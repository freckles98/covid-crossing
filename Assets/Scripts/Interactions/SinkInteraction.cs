...
public class SinkInteraction : Interaction
{
    ...
    protected override void Interact()
    {
        ...
        {
            new DialogueElement("20 seconds", "Perfect! 20 seconds is recommended time for cleaning your hands.", () => scoreManager.ChangeScores(2.5f, 5),
                new DialogueTerminal("OK")),
            new DialogueElement("2 minutes", "Nice job, you're hands are very clean, but you don't need to wash them for so long.", () => scoreManager.ChangeScores(2, 5),
                new DialogueTerminal("OK")),
            new DialogueElement("2 hours", "Wow! You spent two hours washing your hands! Your fingers are very wrinkly and you're feeling very tired.", () => scoreManager.ChangeScores(-20, 5),
                new DialogueTerminal("OK")),
        ...
        DialogueElement dialogue = new DialogueElement(null, "Hey there! Do you want to wash your hands?", null,
            new DialogueElement("Yes", "Would you like to use soap?", SetWasUsedToday,
                new DialogueElement("Yes", "Responsible choice! Soap helps destroying bacteria and viruses. How long would you like to to wash hands for?", () => scoreManager.ChangeScores(2.5f, 5), next),
    ...
    protected override string GetName() => "Sink";
}